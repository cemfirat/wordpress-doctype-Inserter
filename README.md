...
The settings screen includes a live source preview, templates for credits/hiring/developer greetings, an output toggle, and a home-page output check for spotting cache or minification issues. The preview displays input as text and does not execute it.
